...
import (
	...
	versioned "github.com/lcouds/modelzoo/ingress-operator/pkg/client/clientset/versioned"
	internalinterfaces "github.com/lcouds/modelzoo/ingress-operator/pkg/client/informers/externalversions/internalinterfaces"
	v1 "github.com/lcouds/modelzoo/ingress-operator/pkg/client/listers/modelzooetes/v1"
...
func NewFilteredInferenceIngressInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(
		...
		&modelzooetesv1.InferenceIngress{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *inferenceIngressInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&modelzooetesv1.InferenceIngress{}, f.defaultInformer)
}
