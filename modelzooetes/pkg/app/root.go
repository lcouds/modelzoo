...
import (
	...
	"github.com/lcouds/modelzoo/modelzooetes/pkg/signals"
	"github.com/lcouds/modelzoo/modelzooetes/pkg/version"
)
...
const (
	...
	flagInferenceSchedulerName           = "inference-scheduler-name"
)
...
func New() App {
	...
	internalApp.Flags = []cli.Flag{
		...
		&cli.IntFlag{
			...
			EnvVars: []string{"MODELZOOETES_SERVER_PORT"},
			Aliases: []string{"p"},
		},
		&cli.StringFlag{
			Name:    flagMasterURL,
			Usage:   "URL to master for kubernetes cluster",
			EnvVars: []string{"MODELZOOETES_MASTER_URL"},
			Aliases: []string{"mu"},
		},
		&cli.StringFlag{
			Name:    flagKubeConfig,
			Usage:   "Path to kubeconfig file. If not provided, will use in-cluster config",
			EnvVars: []string{"MODELZOOETES_KUBE_CONFIG"},
			Aliases: []string{"kc"},
		},
		&cli.IntFlag{
			Name:    flagQPS,
			...
			Value:   100,
			EnvVars: []string{"MODELZOOETES_KUBE_QPS"},
			Aliases: []string{"kq"},
		},
		&cli.IntFlag{
			Name:    flagBurst,
			...
			EnvVars: []string{"MODELZOOETES_KUBE_BURST"},
			Aliases: []string{"kb"},
		},
		&cli.DurationFlag{
			...
			EnvVars: []string{"MODELZOOETES_KUBE_RESYNC_PERIOD"},
			Aliases: []string{"kr"},
		},
		&cli.IntFlag{
			...
			EnvVars: []string{"MODELZOOETES_CONTROLLER_THREAD_COUNT"},
			Aliases: []string{"ct"},
		},
		&cli.StringFlag{
			...
			EnvVars: []string{"MODELZOOETES_HUGGINGFACE_ENDPOINT"},
			Aliases: []string{"he"},
		},
		&cli.IntFlag{
			...
			EnvVars: []string{"MODELZOOETES_PROBE_READINESS_INITIAL_DELAY_SECONDS"},
		...
		&cli.IntFlag{
			...
			EnvVars: []string{"MODELZOOETES_PROBE_READINESS_PERIOD_SECONDS"},
			Aliases: []string{"prps"},
		},
		&cli.IntFlag{
			...
			EnvVars: []string{"MODELZOOETES_PROBE_READINESS_TIMEOUT_SECONDS"},
			Aliases: []string{"prts"},
		},
		&cli.IntFlag{
			...
			EnvVars: []string{"MODELZOOETES_PROBE_LIVENESS_INITIAL_DELAY_SECONDS"},
		...
		&cli.IntFlag{
			...
			EnvVars: []string{"MODELZOOETES_PROBE_LIVENESS_PERIOD_SECONDS"},
			Aliases: []string{"plps"},
		},
		&cli.IntFlag{
			...
			EnvVars: []string{"MODELZOOETES_PROBE_LIVENESS_TIMEOUT_SECONDS"},
			Aliases: []string{"plts"},
		},
		&cli.IntFlag{
			...
			EnvVars: []string{"MODELZOOETES_PROBE_STARTUP_INITIAL_DELAY_SECONDS"},
		...
		&cli.IntFlag{
			...
			EnvVars: []string{"MODELZOOETES_PROBE_STARTUP_PERIOD_SECONDS"},
			Aliases: []string{"psps"},
		},
		&cli.IntFlag{
			...
			EnvVars: []string{"MODELZOOETES_PROBE_STARTUP_TIMEOUT_SECONDS"},
			Aliases: []string{"psts"},
		},
		&cli.StringFlag{
			...
			Value:   "IfNotPresent",
			EnvVars: []string{"MODELZOOETES_INFERENCE_IMAGE_PULL_POLICY"},
			Aliases: []string{"iipp"},
		},
		&cli.BoolFlag{
			...
			EnvVars: []string{"MODELZOOETES_INFERENCE_SET_UP_RUNTIME_CLASS_NVIDIA"},
		},
		&cli.StringFlag{
			Name:    flagInferenceSchedulerName,
			Usage:   "If exists, will set up schedulerName to the inference deployment.",
			EnvVars: []string{"MODELZOOETES_INFERENCE_SCHEDULER_NAME"},
		},
	}
